...
namespace PairUpInfrastructure.Migrations
{
    ...
    [Migration("20250128154024_AddUsersAndAuthentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PairUpCore.Models.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PairUpCore.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PairUpCore.Models.Activity", b =>
                {
                    b.HasOne("PairUpCore.Models.User", null)
                        .WithMany("LikedActivities")
            ...
            modelBuilder.Entity("PairUpCore.Models.User", b =>
                {
                    b.HasOne("PairUpCore.Models.Role", "Role")
                        .WithMany("Users")
