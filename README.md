...
6. Paste your enviroment variables in here, that looks like the following format:

```  
DB_CONNECTION_STRING="Server={db_host};Port={db_port};Database={db_name};Username={db_username};Password={db_password}"
